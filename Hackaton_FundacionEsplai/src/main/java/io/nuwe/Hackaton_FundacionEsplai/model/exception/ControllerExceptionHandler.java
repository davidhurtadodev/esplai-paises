...
import io.nuwe.Hackaton_FundacionEsplai.model.dto.Message;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<Message> illegalArgumentExceptionHandler (IllegalArgumentException exception, WebRequest request) {
